...
#[allow(dead_code)]
#[inline(always)] 
pub fn big_fact(n: i64,multithread:bool) -> BigUint {
     if multithread {
...
#[allow(dead_code)]
#[inline(always)] #[wasm_bindgen]
pub fn decomp(n: i64,multi:bool) -> String {
...
#[wasm_bindgen]
pub fn list_squared(m: u32, n: u32) -> Array {
   // your code
   ...
   for x in m..=n {
      ...
      if is_perfect_square(d) {
         let n = Array::new();
         n.push(&JsValue::from(x));
         n.push(&JsValue::from(d));
         result.push(&n);
      }
   }
   result
