...
#[bench]
fn crc32_bench(b: &mut Bencher) {
    // exact code to benchmark must be passed as a closure to the iter
    // method of Bencher
    b.iter(|| {
        crc32(black_box("hello world, it is a long line of text"))
    })
}

#[bench]
fn crc3_bench(b: &mut Bencher) {
    b.iter(|| {
        crc3(black_box("hello world, it is a long line of text"))
    })
}
